...
void My_RF24::read_register(uint8_t reg, uint8_t* buf, uint8_t len)
{
...
void My_RF24::write_register(uint8_t reg, const uint8_t* buf, uint8_t len)
{
#if defined(RF24_LINUX) || defined(RF24_RP2)
    beginTransaction();
    uint8_t* prx = spi_rxbuff;
...
void My_RF24::write_register(uint8_t reg, uint8_t value, bool is_cmd_only)
{
    if (is_cmd_only) {
...
void My_RF24::write_payload(const void* buf, uint8_t data_len, const uint8_t writeType)
{
...
void My_RF24::read_payload(void* buf, uint8_t data_len)
{
...
void My_RF24::print_status(uint8_t _status)
{
...
uint8_t My_RF24::sprintf_address_register(char* out_buffer, uint8_t reg, uint8_t qty)
{
    uint8_t offset = 0;
...
My_RF24::My_RF24(uint32_t _spi_speed)
...
void My_RF24::printPrettyDetails(void)
{
...
uint16_t My_RF24::sprintfPrettyDetails(char* debugging_information)
{
...
void My_RF24::encodeRadioDetails(uint8_t* encoded_details)
{
...
bool My_RF24::begin(_SPI* spiBus)
{
    _spi = spiBus;
...
bool My_RF24::begin(_SPI* spiBus, uint16_t _cepin, uint16_t _cspin)
{
    ce_pin = _cepin;
    csn_pin = _cspin;
    return begin(spiBus);
...
bool My_RF24::begin(uint16_t _cepin, uint16_t _cspin)
{
    ce_pin = _cepin;
    csn_pin = _cspin;
    return begin();
...
void My_RF24::startFastWrite(const void* buf, uint8_t len, const bool multicast, bool startTx)
{ //TMRh20
...
bool My_RF24::startWrite(const void* buf, uint8_t len, const bool multicast)
{
...
uint8_t My_RF24::isFifo(bool about_tx)
{
...
bool My_RF24::isFifo(bool about_tx, bool check_empty)
{
...
void My_RF24::disableAckPayload(void)
{
...
bool My_RF24::writeAckPayload(uint8_t pipe, const void* buf, uint8_t len)
{
    if (ack_payloads_enabled) {
        const uint8_t* current = reinterpret_cast<const uint8_t*>(buf);
...
void My_RF24::setPALevel(uint8_t level, bool lnaEnable)
{
...
/****************************************************************************/
void My_RF24::startConstCarrier(rf24_pa_dbm_e level, uint8_t channel)
{
    stopListening();
...
void My_RF24::toggleAllPipes(bool isEnabled)
{
...
uint8_t My_RF24::_data_rate_reg_value(rf24_datarate_e speed)
{
#if !defined(F_CPU) || F_CPU > 20000000
    txDelay = 280;
#else //16Mhz Arduino
...
uint8_t My_RF24::_pa_level_reg_value(uint8_t level, bool lnaEnable)
{
...
void My_RF24::setRadiation(uint8_t level, rf24_datarate_e speed, bool lnaEnable)
{
